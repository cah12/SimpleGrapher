...
def generate_contoured_mesh(f, x_range, y_range, initial_grid_size, threshold, max_depth=8):
...
def generate_contoured_mesh_fast(f, x_range, y_range, initial_grid_size, threshold, max_depth=8):
